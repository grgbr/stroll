...
root_doc = 'index'
master_title = u'Stroll Documentation'
...
latex_documents = [
    ('index', 'stroll.tex', master_title, author, 'manual')
]
...
#man_pages = [
#    (root_doc, 'stroll', master_title, author, 1)
#]
...
texinfo_documents = [
    ('install',
     'stroll_install',
     'Stroll Integration Guide',
     author,
     'Stroll Install',
     'Stroll common C utilities integration manual',
     'Libraries'),
    ('api',
     'stroll_api',
     'Stroll API Guide',
     author,
     'Stroll API',
     'Stroll common C utilities API manual',
     'Libraries')
]
