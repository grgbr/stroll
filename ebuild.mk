...
solibs               := libstroll.so
libstroll.so-objs    += $(call kconf_enabled,STROLL_ASSERT,assert.o)
libstroll.so-objs    += $(call kconf_enabled,STROLL_BITMAP,bitmap.o)
libstroll.so-objs    += $(call kconf_enabled,STROLL_LVSTR,lvstr.o)
