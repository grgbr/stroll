...
def sort_ptest_load(path: str) -> np.array:
...
def sort_ptest_select(results: np.array,
                      algos: np.array,
                      orders: np.array,
                      sizes: np.array,
...
def sort_ptest_print(results: np.array,
                     groupby: list[str],
                     algos: np.array,
                     singles: np.array,
                     orders: np.array,
                     sizes: np.array,
                     nrs: np.array) -> None:
    ptest_print(sort_ptest_select(results, algos, orders, sizes, nrs),
                groupby,
                SORT_PTEST_PROPS)


def sort_ptest_plot_algos_funcof_singles(axe: matplotlib.axes.Axes,
                                         title: Optional[str],
                                         showx: bool,
                                         showy: bool,
                                         results,
...
def sort_ptest_plot_algos_funcof_orders(axe: matplotlib.axes.Axes,
                                        title: Optional[str],
                                        showx: bool,
                                        showy: bool,
                                        results,
...
def sort_ptest_plot_algos_funcof_sizes(axe: matplotlib.axes.Axes,
                                       title: Optional[str],
                                       showx: bool,
                                       showy: bool,
                                       results,
...
def sort_ptest_plot_algos_funcof_nrs(axe: matplotlib.axes.Axes,
                                     title: Optional[str],
                                     showx: bool,
                                     showy: bool,
                                     results,
...
def sort_ptest_plot_singles_funcof_orders(axe: matplotlib.axes.Axes,
                                          title: Optional[str],
                                          showx: bool,
                                          showy: bool,
                                          results,
...
def sort_ptest_plot_singles_funcof_sizes(axe: matplotlib.axes.Axes,
                                         title: Optional[str],
                                         showx: bool,
                                         showy: bool,
                                         results,
...
def sort_ptest_plot_singles_funcof_nrs(axe: matplotlib.axes.Axes,
                                       title: Optional[str],
                                       showx: bool,
                                       showy: bool,
                                       results,
...
def sort_ptest_plot_orders_funcof_singles(axe: matplotlib.axes.Axes,
                                          title: Optional[str],
                                          showx: bool,
                                          showy: bool,
                                          results,
...
def sort_ptest_plot_orders_funcof_sizes(axe: matplotlib.axes.Axes,
                                        title: Optional[str],
                                        showx: bool,
                                        showy: bool,
                                        results,
...
def sort_ptest_plot_orders_funcof_nrs(axe: matplotlib.axes.Axes,
                                      title: Optional[str],
                                      showx: bool,
                                      showy: bool,
                                      results,
...
def sort_ptest_plot_sizes_funcof_orders(axe: matplotlib.axes.Axes,
                                        title: Optional[str],
                                        showx: bool,
                                        showy: bool,
                                        results,
...
def sort_ptest_plot_sizes_funcof_singles(axe: matplotlib.axes.Axes,
                                         title: Optional[str],
                                         showx: bool,
                                         showy: bool,
                                         results,
...
def sort_ptest_plot_sizes_funcof_nrs(axe: matplotlib.axes.Axes,
                                     title: Optional[str],
                                     showx: bool,
                                     showy: bool,
                                     results,
...
def sort_ptest_plot_nrs_funcof_orders(axe: matplotlib.axes.Axes,
                                      title: Optional[str],
                                      showx: bool,
                                      showy: bool,
                                      results,
...
def sort_ptest_plot_nrs_funcof_singles(axe: matplotlib.axes.Axes,
                                       title: Optional[str],
                                       showx: bool,
                                       showy: bool,
                                       results,
...
def sort_ptest_plot_nrs_funcof_sizes(axe: matplotlib.axes.Axes,
                                     title: Optional[str],
                                     showx: bool,
                                     showy: bool,
                                     results,
...
SORT_PTEST_SINGLE_PLOTTERS = {
        'algo':  {
            'single': sort_ptest_plot_algos_funcof_singles,
            'order':  sort_ptest_plot_algos_funcof_orders,
            'size':   sort_ptest_plot_algos_funcof_sizes,
            'nr':     sort_ptest_plot_algos_funcof_nrs
        },
        'single':  {
            'order':  sort_ptest_plot_singles_funcof_orders,
            'size':   sort_ptest_plot_singles_funcof_sizes,
            'nr':     sort_ptest_plot_singles_funcof_nrs
        },
        'order':  {
            'single': sort_ptest_plot_orders_funcof_singles,
            'size':   sort_ptest_plot_orders_funcof_sizes,
            'nr':     sort_ptest_plot_orders_funcof_nrs
        },
        'size':  {
            'order':  sort_ptest_plot_sizes_funcof_orders,
            'single': sort_ptest_plot_sizes_funcof_singles,
            'nr':     sort_ptest_plot_sizes_funcof_nrs
        },
        'nr':  {
            'order':  sort_ptest_plot_nrs_funcof_orders,
            'single': sort_ptest_plot_nrs_funcof_singles,
            'size':   sort_ptest_plot_nrs_funcof_sizes
        }
}


def sort_ptest_single_plotter(funcof: list[str]) -> Callable[[matplotlib.axes.Axes,
                                                              Optional[str],
                                                              bool,
                                                              bool,
                                                              np.array,
                                                              ...
                                                              np.array],
                                                             None]:
    plotter: object = SORT_PTEST_SINGLE_PLOTTERS
    for fld in funcof:
...
def sort_ptest_plots_title(group_field: Optional[str],
...
def sort_ptest_show_single_plot(results,
                                 funcof: list[str],
                                 algos: np.array,
                                 singles: np.array,
                                 orders: np.array,
                                 sizes: np.array,
                                 nrs: np.array) -> None:
    plotter = sort_ptest_single_plotter(funcof)

    fig, axe = plt.subplots(nrows = 1, ncols = 1, constrained_layout = True)
    title = sort_ptest_plots_title(None,
                                   funcof,
                                   algos,
                                   singles,
                                   orders,
...
def sort_ptest_plot_algo_group(results: np.array,
                               title: str,
                               plotter,
                               algos: np.array,
                               singles: np.array,
...
def sort_ptest_plot_distinct_group(results: np.array,
                                   title: str,
                                   plotter,
                                   algos: np.array,
                                   singles: np.array,
...
def sort_ptest_plot_order_group(results: np.array,
                                title: str,
                                plotter,
                                algos: np.array,
                                singles: np.array,
...
def sort_ptest_plot_size_group(results: np.array,
                               title: str,
                               plotter,
                               algos: np.array,
                               singles: np.array,
...
def sort_ptest_plot_nr_group(results: np.array,
                             title: str,
                             plotter,
                             algos: np.array,
                             singles: np.array,
...
SORT_PTEST_GROUP_PLOTTERS = {
        'algo':   sort_ptest_plot_algo_group,
        'single': sort_ptest_plot_distinct_group,
        'order':  sort_ptest_plot_order_group,
        'size':   sort_ptest_plot_size_group,
        'nr':     sort_ptest_plot_nr_group
}


def sort_ptest_show_plots_group(results,
                                group: str,
                                funcof: list[str],
                                algos: np.array,
                                singles: np.array,
                                ...
                                sizes: np.array,
                                nrs: np.array) -> None:
    group_plotter = SORT_PTEST_GROUP_PLOTTERS[group]
    funcof_plotter = sort_ptest_single_plotter(funcof)
    title = sort_ptest_plots_title(group,
                                   funcof,
                                   algos,
                                   singles,
                                   orders,
...
def sort_ptest_parse_print_groupby(arg: str) -> list[str]:
    return ptest_parse_clause(arg, 'groupby', SORT_PTEST_PROPS)


def sort_ptest_parse_plot_groupby(arg: str) -> str:
    if arg not in SORT_PTEST_GROUP_PLOTTERS.keys():
        raise argp.ArgumentError(None,
                                 "'" + arg + "': unexpected plot group field.")
    return arg


def sort_ptest_parse_plot_funcof(arg: str) -> list[str]:
    return ptest_parse_clause(arg, 'funcof', SORT_PTEST_SINGLE_PLOTTERS)
...
def main():
    ...
    print_parser.add_argument('-g', '--groupby',
                              dest = 'groupby',
                              type = sort_ptest_parse_print_groupby,
    ...
    plot_parser.add_argument('-f', '--funcof',
                             dest = 'funcof',
                             type = sort_ptest_parse_plot_funcof,
                             default = 'algo,order',
                             metavar = 'RESULT_FIELDS',
    ...
    plot_parser.add_argument('-g', '--groupby',
                             dest = 'groupby',
                             type = sort_ptest_parse_plot_groupby,
                             default = None,
                             metavar = 'RESULT_FIELDS',
    ...
    try:
        results = sort_ptest_load(args.results_path)
        ...
        if args.cmd == 'list':
            sort_ptest_list(results, algos, singles, orders, sizes, nrs)
        elif args.cmd == 'print':
            sort_ptest_print(results,
                             args.groupby,
                             algos,
                             singles,
                             orders,
            ...
            if args.groupby is not None:
                sort_ptest_show_plots_group(results,
                                            args.groupby,
                                            args.funcof,
                                            algos,
                                            singles,
                ...
                sort_ptest_show_single_plot(results,
                                            args.funcof,
                                            algos,
                                            singles,
                                            orders,
